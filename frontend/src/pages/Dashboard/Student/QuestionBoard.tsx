import { Button, Card, CardContent, DialogContentText, Grid, Input, makeStyles, Typography } from '@material-ui/core';
...
export const QuestionBoard: FC = () => {
  ...
  return (
    <div>
      ...
      <MaxWidthDialog title='Peer Review' open={peerReview} setOpen={setPeerReview} width={'xl'}>
        <DialogContentText>Review peers assigned to you</DialogContentText>
      ...
      <MaxWidthDialog title='Gradebook' open={gradeBook} setOpen={setGradeBook} width={'xl'}>
        <DialogContentText>This is the review you have received for your work</DialogContentText>
